    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        corner_4 = rg.Point(intersection_center.x + letter_thickness/2,
    ...
    def clone(self):
        ...
        clone_h_rect = rg.Rectangle(self.h_rect.corner_1.clone(), self.h_rect.corner_2.clone())
        clone_v_rect = rg.Rectangle(self.v_rect.corner_1.clone(), self.v_rect.corner_2.clone())
        clone_thickness = clone_h_rect.corner_2.y - clone_h_rect.corner_1.y
        clone_width = clone_h_rect.corner_2.x - clone_h_rect.corner_1.x
        clone_height = clone_v_rect.corner_2.y - clone_v_rect.corner_1.y
        clone_center = rg.Point(clone_h_rect.corner_1.x + clone_width/2, clone_v_rect.corner_1.y + clone_thickness/2)
        clone_outline_color = self.v_rect.outline_color
        clone_fill_color = self.h_rect.fill_color
        cloneT = CapitalT(clone_center, clone_width, clone_height, clone_thickness)
        cloneT.set_colors(clone_fill_color, clone_outline_color)
